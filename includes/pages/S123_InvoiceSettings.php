...
class S123_InvoiceSettings extends S123_BaseController
{
    ...
    public function s123_submit_invoice_settings()
    {
        if (isset($_POST['s123_security']) && wp_verify_nonce($_POST['s123_security'], 's123_security')) {
            ...
            $data['default_advanced_invoices'] = isset($_POST['default_advanced_invoices']);
            $data['create_invoice_on_order_creation'] = isset($_POST['create_invoice_on_order_creation']);
            $data['create_unpaid_invoices'] = isset($_POST['create_unpaid_invoices']);
